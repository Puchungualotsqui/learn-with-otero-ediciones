...
type User struct {
	...
	Classes           []int  `json:"classes"` // Hydrated
}
...
type Class struct {
	...
	Users       []string `json:"users"` // Hydrated
}
...
type Assignment struct {
	...
	Description string   `json:"description"`
	Content     []string `json:"content"`  // url to some file // Hydrated
...
type Submission struct {
	Username    string   `json:"username"`
	Description string   `json:"description"`
	Content     []string `json:"content"`      // could be file path or text // Hydrated
